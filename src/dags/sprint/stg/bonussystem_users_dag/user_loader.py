...
class UserOriginRepository:
    ...
    def list_user(self, user_threshold: int, limit:int) -> List[UserObj]:
...
class UserLoader:
    WF_KEY = "sprint_user_origin_to_stg_workflow"
    ...
    def load_user(self):
        ...
        with self.pg_dest.connection() as conn:
            ...
            load_queue = self.origin.list_user(last_loaded, self.BATCH_LIMIT)
