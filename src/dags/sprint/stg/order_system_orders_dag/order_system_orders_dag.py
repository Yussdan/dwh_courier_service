...
from sprint.stg.order_system_orders_dag.pg_saver import PgSaver
from sprint.stg.order_system_orders_dag.orders_loader import OrdersLoader
from sprint.stg.order_system_orders_dag.orders_reader import OrdersReader
...
def sprint5_sprint_stg_order_system_orders():
...
order_stg_dag = sprint5_sprint_stg_order_system_orders()  # noqa
