...
from sprint.stg.order_system_restaurants_dag.pg_saver import PgSaver
from sprint.stg.order_system_restaurants_dag.restaurant_loader import RestaurantLoader
from sprint.stg.order_system_restaurants_dag.restaurant_reader import RestaurantReader
from sprint import ConnectionBuilder, MongoConnect
...
@dag(
    ...
    tags=['sprint5', 'sprint', 'stg', 'origin'],  # Теги, используются для фильтрации в интерфейсе Airflow.
    is_paused_upon_creation=True  # Остановлен/запущен при появлении. Сразу запущен.
)
def sprint5_sprint_stg_order_system_restaurants():
...
order_stg_dag = sprint5_sprint_stg_order_system_restaurants()  # noqa
