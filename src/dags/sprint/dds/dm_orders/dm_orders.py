...
from sprint.dds.dm_orders.dm_orders_loader import dm_orders_loader
...
def sprint5_sprint_dds_dm_orders_dag():
    ...
    def load_dm_orders():
        ...
        rest_loader = dm_orders_loader(origin_pg_connect, dwh_pg_connect, log)
...
dds_dm_orders_dag = sprint5_sprint_dds_dm_orders_dag()