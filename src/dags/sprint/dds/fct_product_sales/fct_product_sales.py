...
from sprint.dds.fct_product_sales.fct_product_sales_loader import fct_product_sales_loader
...
def sprint5_sprint_dds_fct_product_sales_dag():
    ...
    def load_fct_product_sales():
        ...
        rest_loader = fct_product_sales_loader(origin_pg_connect, dwh_pg_connect, log)
...
dds_fct_product_sales_dag = sprint5_sprint_dds_fct_product_sales_dag()